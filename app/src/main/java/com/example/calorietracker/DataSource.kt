...
object DataSource {
    ...
    val userList = mutableListOf(User(0, "Кошка Машка", "https://cataas.com/cat/cute", 5.4f, 0f, mealList
        ))

//    val list = mutableListOf<RecyclerData>(userList, mealList).add)

//    val list = mutableListOf(
//        User(0, "Кошка Машка", "https://cataas.com/cat/cute", 5.4f, 0f, listOf()),
//
//        TextLine,
//
//        Meal(
