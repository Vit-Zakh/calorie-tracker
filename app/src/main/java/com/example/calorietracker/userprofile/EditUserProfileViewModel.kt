...
class EditUserProfileViewModel @Inject constructor(
    ...
    val currentUserData: LiveData<DailyIntakeProps> = editedUserProfileRepository.editedUser.map { userState ->
    ...
    fun saveToSharedPreferences(userName: String, userWeight: String, userAge: String, userIncome: String, userImageUrl: String, userBackgroundUrl: String) {
        editedUserProfileRepository.saveToSharedPreferences(userName, userWeight, userAge, userIncome, userImageUrl, userBackgroundUrl)
    }
